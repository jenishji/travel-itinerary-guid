...
const TripForm = ({ onSubmit, onCancel, isLoading, initialData }) => {
  ...
  // Explicit handler for the close button
    ...
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg relative overflow-hidden 
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          <FaPlaneDeparture className="text-3xl text-blue-600 mr-3" />
          <div>
        ...
        <button 
          ...
          className="text-gray-500 hover:text-red-500 text-xl transition-colors duration-300 p-2 z-50"
        >
      ...
      <form onSubmit={handleSubmit} className="relative z-10">
        ...
        {/* Trip timing section */}
        <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
          <h3 className="text-lg font-medium text-gray-800 mb-3">Trip Timing</h3>
        ...
        <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
          <h3 className="text-lg font-medium text-gray-800 mb-3">Trip Preferences</h3>
          ...
          <div className="mt-4">
            <div className="flex items-center p-3 bg-white rounded-md border border-blue-100 transition-all duration-300 hover:bg-blue-50">
              <input
                id="visitNearby"
                name="visitNearby"
                type="checkbox"
              ...
              <label className="ml-2 text-gray-700 flex items-center" htmlFor="visitNearby">
                ...
                Include nearby attractions and day trips in my itinerary
              </label>
            </div>
          </div>
        </div>
        
        {/* Tooltip explanations for pace options */}
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200 text-sm">
          <h4 className="font-medium text-gray-700 mb-2">Trip Pace Explained:</h4>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {paceOptions.map((option) => (
              <li key={option.value} className="flex items-start">
                <span className="font-medium text-blue-600 mr-1">{option.value}:</span>
        ...
        <div className="mt-6 text-center">
          <button
            type="submit"
            disabled={isLoading}
            className={`bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-md transition duration-300 shadow-md ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
            {isLoading ? (
